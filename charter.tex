...
\tikzstyle{arrowc} = [line width=0.5mm, red,->,>=stealth]
...
\begin{tikzpicture}[node distance=1cm]
    ...
    %lines and arrows
    \draw[arrowc] (start) -- (task1-1);
    \draw[arrowc] (task1-1) -- (task1-2);
    \draw[arrowc] (task1-2) -- node {} ++(1.5cm,0) -- node {} ++(0, 1cm) -- (task2-1);
    \draw[arrow] (task1-2) -- node {} ++(1.5cm,0) -- node {} ++(0,-1cm) -- (task2-2);
    \draw[arrowc] (task2-1) -- (task2-3);
    \draw[arrowc] (task2-3) -- (task2-4);
    \draw[arrow] (task2-2) -- (task2-5);
    \draw[arrowc] (task2-4) -- node {} ++(1.5cm,0) -- node {} ++(0,-3.1cm) -- node {} ++(-16.7cm,0) -- node {} ++(0,-7.9cm) -- (task3-1);
    \draw[arrow] (task2-5) -- node {} ++(4.5cm,0) -- node {} ++(0,-1.1cm) -- node {} ++(-16.7cm,0) -- node {} ++(0,-1.9cm) -- (task2-6);
    ...
    \draw[arrowc] (task3-1) -- (task3-2);
    \draw[arrow] (task3-2) -- node {} ++(1.5cm,0) -- node {} ++(0, 1cm) -- (task3-3);
    \draw[arrowc] (task3-2) -- node {} ++(1.5cm,0) -- node {} ++(0,-1cm) -- (task3-4);
    \draw[arrow] (task2-9) -- (task4-1);
    \draw[arrow] (task2-10) -- (task4-2);
    \draw[arrow] (task4-1) -- (task4-3);
    \draw[arrow] (task4-2) -- (task4-4);

    \draw[arrow] (task3-3) -- node {} ++(1.3cm,0) -- node {} ++(0,-1cm) -- node {} ++(0.3cm,0) -- node {} ++(0,3cm) --     (task3-5);
    \draw[arrowc] (task3-4) -- node {} ++(1.3cm,0) -- node {} ++(0, 1cm) -- node {} ++(0.3cm,0) -- node {} ++(0,-3cm) --     (task3-8);
    \draw[arrow] (task3-3) -- node {} ++(1.3cm,0) -- node {} ++(0,-1cm) -- node {} ++(0.3cm,0) -- node {} ++(0,-1cm) --   (task3-7);
    \draw[arrowc] (task3-4) -- node {} ++(1.3cm,0) -- node {} ++(0, 1cm) -- node {} ++(0.3cm,0) -- node {} ++(0, 1cm) --   (task3-6);

    \draw[arrow] (task3-5) -- (task5-1);
    \draw[arrowc] (task3-6) -- (task5-2);
    \draw[arrow] (task3-7) -- (task5-4);
    \draw[arrowc] (task3-8) -- (task5-3);
    ...
    \draw[arrowc] (task5-2) -- node {} ++(1.5cm,0) -- node {} ++(0,-5.1cm)   -- node {} ++(-16.7cm,0) -- node {} ++(0,-1.4cm) -- (task3-9);
    \draw[arrow] (task5-4) -- node {} ++(1.5cm,0) -- node {} ++(0,-3.1cm)   -- node {} ++(-16.7cm,0) -- node {} ++(0,-1.4cm) -- (task3-9);
    \draw[arrowc] (task5-3) -- node {} ++(1.5cm,0) -- node {} ++(0,-1.1cm)   -- node {} ++(-16.7cm,0) -- node {} ++(0,-1.4cm) -- (task3-9);
    
    \draw[arrowc] (task3-9) -- (task5-5);
    \draw[arrowc] (task5-5) -- (task6-1);
    \draw[arrowc] (task6-1) -- (task6-2);
    \draw[arrowc] (task6-2) -- (end);
...
\multirow{-2}{*}{\cellcolor[HTML]{C0C0C0}\begin{tabular}[c]{@{}c@{}}Código\\ WBS\end{tabular}} & \multirow{-2}{*}{\cellcolor[HTML]{C0C0C0}\begin{tabular}[c]{@{}c@{}}Nombre \\ tarea\end{tabular}} & Notebook & Kit de Desarrollo STM32 & Heladera & Freezer \\ \hline
 1      & Organización del proyecto                                             &   45  &   - &     - & - \\ \hline
 1.1    & Búsqueda, instalación y configuración de herramientas para gestión    &   5   &   - &     - & - \\ \hline
 1.2    & Elaboración del informe de planificación del proyecto                 &   40  &   - &     - & - \\ \hline
 2      & I+D Hardware                                                          &   216 &   - &     - & - \\ \hline
 2.1    & Investigación y selección de módulos WiFi                             &   8   &   - &     - & - \\ \hline
 2.2    & Investigación y selección del modem 4G                                &   8   &   - &     - & - \\ \hline
 2.3    & Investigación y selección del sensor de temperatura                   &   8   &   - &     - & - \\ \hline
 2.4    & Investigación y selección del microcontrolador para el nodo sensor    &   8   &   - &     - & - \\ \hline 
 2.5    & Investigación y selección del microcontrolador para el equipo central &   8   &   - &     - & - \\ \hline
 2.6    & Investigación y selección de la batería para los equipos              &  16   &   - &     - & - \\ \hline
 2.7    & Desarrollo del circuito esquemático del modulo sensor                 &  40   &  40 &     - & - \\ \hline
 2.8    & Desarrollo del circuito esquemático del equipo central                &  40   &  40 &     - & - \\ \hline
 2.9    & Desarrollo del PCB del modulo sensor                                  &  40   &  40 &     - & - \\ \hline
