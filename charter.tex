...
\titulo{Equipo de monitoreo y trazabilidad de cadena de frio de medicamentos en tiempo real} 
...
\cliente{Cristian Marcelo Funes}
\empresaCliente{Emprendimiento Propio}
...
\fechaFINALPlanificacion{NN de octubre de 2020} 	%Fecha de final de cursada de GdP
\fechaFINALTrabajo{NN de agosto de 2021}		%Fecha de defensa pública del trabajo final
...
Por medio de la presente se acuerda con el Ing. \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'', consistirá esencialmente en el prototipo preliminar de un sistema de monitoreo y trazabilidad de cadena de frio de medicamentos en tiempo real, y tendrá un presupuesto preliminar estimado de 600 hs de trabajo y \textcolor{red}{\$XXX}, con fecha de inicio \fechaInicioName\hspace{1px} y fecha de presentación pública \fechaFinalName.
